...
for (var i = 0; i < acc.length; i++) {
	acc[i].addEventListener("click", function () {//The event listener listens for click events
		...
		var panel = this.nextElementSibling;//Get the next element after the accordion button (the panel): https://www.w3schools.com/jsref/prop_element_nextelementsibling.asp
